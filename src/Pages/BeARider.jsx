...
import riderImg from "../assets/assets/agent-pending.png"; // Adjust path if needed

// Reusable Dropdown with Chevron and Animation
...
const BeARider = () => {
    ...
    // Sync dropdown selection with react-hook-form values
    const handleRegionSelect = (region) => {
        setSelectedRegion(region);
        setSelectedDistrict("");
        setValue("region", region);
        setValue("district", ""); // reset district in form
    };
                        ...
                        <div className="space-y-6">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    {/* Email (read-only) */}
                                    <div className="space-y-2">
                                        <label className="text-slate-700 font-medium">Your Email</label>
                                        <input
                                            type="email"
                                            value={user?.email || ""}
                                            readOnly
                                    ...
                                    {/* National ID */}
                                    <div className="space-y-2">
                                        <label htmlFor="nid" className="text-slate-700 font-medium">
                                    ...
                                    {/* Bike Brand */}
                                    <div className="space-y-2">
                                        <label htmlFor="bike_brand" className="text-slate-700 font-medium">
                                            Bike Brand (e.g., Yamaha FZ)
                                        </label>
                                        <input
                                            id="bike_brand"
                                            type="text"
                                    ...
                                    {/* Bike Registration */}
                                    <div className="space-y-2">
                                        <label htmlFor="bike_registration" className="text-slate-700 font-medium">
